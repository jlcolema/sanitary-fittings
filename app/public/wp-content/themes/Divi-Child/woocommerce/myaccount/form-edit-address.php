...
<?php else : ?>
  ...
  <span class="account-back"><a href="<?php echo esc_url( wc_get_account_endpoint_url( 'edit-address' ) ) ?>"><?php echo apply_filters( 'woocommerce_my_account_edit_address_title', $page_title, $load_address ); ?></a></span>  
