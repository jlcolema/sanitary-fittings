...
<span class="account-back"><a href="<?php echo esc_url( wc_get_account_endpoint_url( 'dashboard' ) ) ?>">Account Details</a></span>
...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<fieldset>
		<legend><div class="password-heading"><?php esc_html_e( 'Password change', 'woocommerce' ); ?></div></legend>
